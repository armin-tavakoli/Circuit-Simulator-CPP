...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->voltageReceived((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Client::*)(const QString & )>(_a, &Client::logMessage, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (Client::*)(double )>(_a, &Client::voltageReceived, 1))
            return;
    }
}
...
// SIGNAL 1
void Client::voltageReceived(double _t1)
{
